...
function __fish_spotify_player_global_optspecs
    string join \n t/theme= c/config-folder= C/cache-folder= o/config-override= d/daemon h/help V/version
end
...
complete -c spotify_player -n "__fish_spotify_player_needs_command" -s o -l config-override -d 'Override a config option (e.g. -o device.volume=80 -o theme=dracula)' -r
...
complete -c spotify_player -n "__fish_spotify_player_needs_command" -f -a "lyrics" -d 'Print provided track\'s lyrics or current playing track, if no argument specified'
...
complete -c spotify_player -n "__fish_spotify_player_using_subcommand lyrics" -s i -l id -r
complete -c spotify_player -n "__fish_spotify_player_using_subcommand lyrics" -s n -l name -r
complete -c spotify_player -n "__fish_spotify_player_using_subcommand lyrics" -s h -l help -d 'Print help'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features lyrics help" -f -a "get" -d 'Get Spotify data'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features lyrics help" -f -a "playback" -d 'Interact with the playback'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features lyrics help" -f -a "connect" -d 'Connect to a Spotify device'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features lyrics help" -f -a "like" -d 'Like currently playing track'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features lyrics help" -f -a "authenticate" -d 'Authenticate the application'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features lyrics help" -f -a "playlist" -d 'Playlist editing'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features lyrics help" -f -a "generate" -d 'Generate shell completion for the application CLI'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features lyrics help" -f -a "search" -d 'Search spotify'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features lyrics help" -f -a "features" -d 'Print compiled in features'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features lyrics help" -f -a "lyrics" -d 'Print provided track\'s lyrics or current playing track, if no argument specified'
complete -c spotify_player -n "__fish_spotify_player_using_subcommand help; and not __fish_seen_subcommand_from get playback connect like authenticate playlist generate search features lyrics help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
